...
export const main = (masterPasssword: string, token: string, key_1: string, key_2: string, key_3: string): string => {
    ...
    const data: DecryptedOutput = decryptText({ token: token3.data, password: token1.token });
