...
export const main = (masterPasssword: string, data: string, key_1: string, key_2: string, key_3: string): string => {
    ...
    const token4: EncryptedOutput = encryptText({ text: token2.token, password: key_3 });
